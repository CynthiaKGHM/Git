...
from f0902 f 
where gbco = '00004' and gblt = 'AA' and trim(gbobj) in ('7115','7125','7127', '7131','7141','7146', '7151', '7156', '7158') and gbfy = 24 and gbmcu <> '401650'
...
select gbobj as object_account, gbsub as subsidiary, sum(gban01/100) as January, sum(gban02/100) as February, sum(gban03/100) as March, sum(gban04/100) as April, 
 sum(gban05/100) as May, sum(gban06/100) as June, sum(gban07/100) as July, sum(gban08/100) as August,
  sum(gban09/100) as September, sum(gban10/100) as October, sum(gban11/100) as November, sum(gban12/100) as December
from f0902 f 
where gbco = '00002' and gblt = 'AA' and trim(gbobj) in ('7115','7125','7127', '7131','7141', '7146', '7151', '7156', '7158') and gbfy = 24 
group by f.gbobj, f.gbsub 
...
select gbobj as object_account, gbsub as subsidiary, sum(gban01/100) as January, sum(gban02/100) as February, sum(gban03/100) as March, sum(gban04/100) as April, 
 sum(gban05/100) as May, sum(gban06/100) as June, sum(gban07/100) as July, sum(gban08/100) as August,
  sum(gban09/100) as September, sum(gban10/100) as October, sum(gban11/100) as November, sum(gban12/100) as December
from f0902 f 
where gbco in ('00001') and gblt = 'AA' and trim(gbobj) in ('7115','7125','7127', '7131','7141','7146', '7151', '7156', '7158') and gbfy = 24 and gbmcu <> '401650'
group by f.gbobj, f.gbsub 
